import { BasicExpressionToken, MappingToken, ScalarToken, SequenceToken, StringToken, TemplateToken } from "../templates/tokens";
...
export type WorkflowCallConfig = {
    inputs?: {
        [inputName: string]: InputConfig & {
            default?: string | boolean | number | ScalarToken;
        };
    };
    secrets?: {
